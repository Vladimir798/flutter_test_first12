        ...
        actions: <Widget>[
          ...
          IconButton(
              onPressed:
                ...
                setState(
                        () {
                      _ic = const Icon(Icons.accessibility_new, size: 35,);
                      Future.delayed(const Duration(milliseconds: 100),
                              () => setState(() {
                            _ic = const Icon(Icons.accessibility, size: 35,);
                          })
                      );
                    }
                );
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () => setState(() => _w=Image.asset('assets/Геометриякруг.png', fit: BoxFit.contain,)),
            ),
            const Divider(),
            ListTile(
